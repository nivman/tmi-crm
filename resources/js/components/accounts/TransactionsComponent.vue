            ...
            <div class="panel-block">
                ...
                >
                    ...
                    <template slot="account" slot-scope="props">
                        <div class="">
                            {{
                                props.row.journal.morphed
                                    ? props.row.journal.morphed.name + ' (' + props.row.journal.morphed.reference + ')'
                                    : ''
                            }}
                        </div>
                    </template>
...
export default {
    data() {
        return {
            columns: ['id', 'created_at', 'account', 'subject_type', 'subject_id', 'debit', 'credit', 'type'],
            options: {
    ...
    computed: {
        url() {
            return `app/accounts/transactions/${this.$route.params.id ? this.$route.params.id : ''}`;
        },
    },
    watch: {
        $route(to, from) {
