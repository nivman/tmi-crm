  ...
  <div class="wrapper">
    <div class="panel panel-default">
      <div class="panel-heading panel-heading-title" >
        ...
        <router-link to="/settings/notes-categories/add" class="button is-link is-small is-pulled-right">
          <i class="fas fa-plus m-l-sm" /> הוספת תגית לפתק
        </router-link>
        <span class="table-title">קטגוריות פתקים</span>

      </div>
      <div class="panel-block">

        <v-server-table name="statusesTable" :url="url" :columns="columns" :options="options" ref="notesCategoriesTable" >
          ...
          <template slot="actions" slot-scope="props">
            <div class="buttons has-addons is-centered">
              <p class="control tooltip">
                <router-link :to="'/settings/notes-categories/edit/' + props.row.id" class="button is-warning is-small">
...
export default {
  mixins: [mId, tBus('app/notes-categories')],
  data() {
    return {
