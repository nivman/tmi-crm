  ...
  <div class="wrapper">
    <div class="panel panel-default">
      <div class="panel-heading panel-heading-title" >
        ...
        <router-link to="/settings/Statuses/add" class="button is-link is-small is-pulled-right">
          <i class="fas fa-plus m-l-sm" /> הוספת סטטוס חדש
        </router-link>
        <span class="table-title">סטטוס</span>
          ...
          <template slot="actions" slot-scope="props">
            <div class="buttons has-addons is-centered">
              <p class="control tooltip">
                <router-link :to="'/settings/statuses/edit/' + props.row.id" class="button is-warning is-small">
...
export default {
  mixins: [mId, tBus('app/statuses')],
  data() {
    return {
      columns: ['name', 'entity_name', 'color', 'actions'],
