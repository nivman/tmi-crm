...
module.exports = function(promiseOnly) {
    ...
    var data = ((_data = {}),
    _defineProperty(_data, keys.query, this.filteredQuery),
    _defineProperty(_data, keys.limit, this.limit),
    _defineProperty(_data, keys.ascending, this.orderBy.ascending ? 1 : 0),
    _defineProperty(_data, keys.page, this.page),
    _defineProperty(_data, keys.byColumn, !this.filteredQuery && this.filteredQuery == "" ? 1 : 0),
    _data);
