...
class Task extends ModelForm
{
    ...
    protected $fillable = ['id', 'name', 'details', 'start_date', 'end_date','customer_id', 'priority_id', 'status_id', 'estimated_time', 'actual_time', 'date_to_complete','notification_time'];
